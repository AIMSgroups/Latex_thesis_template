...
``USFthesis'' is a LaTeX class for thesis and dissertation authors at the University of South Florida (USF). It is adapted from the USFthesis class by David C. Anastasiu, which in turn derives from IEEEtran. It follows the current USF Graduate Studies and College of Engineering electronic thesis and dissertation (ETD) guidelines and attempts to simplify manuscript formatting. Students should, however, read the current ETD requirements carefully and rectify any style discrepancies before submitting. Note that USF format review is strict on grammar, spelling, and margin compliance.

The present ``thesis'' serves as a visual example of what the finished thesis product should look like. In addition, it provides some guidance on how to use the USFthesis style, the provided LaTeX template project, and LaTeX in general to produce a quality thesis that complies with USF ETD requirements. LaTeX, in combination with the provided style, automate many of the style aspects of the thesis, as long as students do not modify the style of introduce new style elements manually in the text. For example, one can make all section titles bold by simply putting the text within a \texttt{{\textbackslash}textbf} block. However, that would break the style and cause the thesis to be returned for edits during USF format review. Students are thus, once again, urged to refrain from style modifications and to double-check style compliance against the USF ETD format guide before submitting their theses.
...
This chapter contains a list of common writing mistakes that students tend to make when writing theses. Students should read the list carefully, in addition to the examples provided in the USF ETD format guide, and guard against making these mistakes in their theses.


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Future Work}\label{sec:future_work}

First of all, we plan to finish this template example and, once the style/template has been approved by USF Graduate Studies, disseminate it to others in the college. We plan to invite contributions from other USF faculty in improving this document, with the goal to include the most useful information to help students succeed in writing their thesis.


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Conclusions}\label{sec:conclusions}
This macro example thesis was written as a guide to USF graduate students for writing quality theses in LaTeX. The provided template, along with this guide, should make the task of complying with USF ETD formatting requirements much easier for students. The USF LaTeX thesis and dissertation template and this document are a work in progress. The reader is invited to participate in improving both via Git pull requests. The project can be found at \url{https://github.com/davidanastasiu/thesis_template-SJSU_CMPE} (the upstream SJSU project this template was adapted from).
